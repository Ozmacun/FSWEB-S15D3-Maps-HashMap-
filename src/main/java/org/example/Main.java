...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        employees.add(new Employee(1, "Tolga", "Ozmacun"));
        employees.add(new Employee(2, "Ahmet", "Ozmacun"));
        employees.add(new Employee(3, "Müberra", "Ozmacun"));
        employees.add(new Employee(4, "Leo", "Ozmacun"));
        employees.add(new Employee(2, "Ahmet", "Ozmacun"));//Duplicate
        employees.add(new Employee(3, "Müberra", "Ozmacun"));//Duplicate
